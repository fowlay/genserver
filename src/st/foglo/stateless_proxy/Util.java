...
public final class Util {
    ...
    public static void seq(Mode mode, Side where, Direction towards,
        ...
        seq(mode, where, towards, String.format(format, number));
    }

    public static void seq(Mode mode, Side where, Direction towards,
            String format, String text) {
        seq(mode, where, towards, String.format(format, text));
    }

    public static void seq(Mode mode, Side where, Direction towards,
            String format, String text1, String text2) {
        seq(mode, where, towards, String.format(format, text1, text2));
    }
     ...
     * @return
     */
    public static String mergeStrings(String u, String a, String b) {
        if (b.length() > a.length()) {
            return mergeStrings(u, b, a);
        } else {
            // a is longer than b, or equal length
            final char[] aa = a.toCharArray();
            final char[] bb = b.toCharArray();
            final StringBuilder sb = new StringBuilder(u);
            sb.append('|');
