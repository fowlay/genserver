...
public class CoreUdpCb extends UdpCb {
    ...
    public InitResult init(Object[] ignored) {
        ...
        channelWrapper = new ChannelWrapper(side,
                sipAddrSp, sipPortSp,
                outgoingProxyAddr, outgoingProxyPort);
        ...
        Util.seq(Mode.START, side, Direction.NONE,
                "done init, returning: %s", result.toString());
        return result;
    }
    ...
    public InfoResult handleInfo(Object message) {
        ...
        if (udpInfoResult.timedOut) {
            ...
            final KeepAliveMessage kam =
                    new KeepAliveMessage(side, recBuffer, udpInfoResult.datagramSize);
